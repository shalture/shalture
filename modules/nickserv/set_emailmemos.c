...
command_t ns_set_emailmemos = { "EMAILMEMOS", N_("Forwards incoming memos to your e-mail address."), AC_AUTHENTICATED, 1, ns_cmd_set_emailmemos, { .path = "nickserv/set_emailmemos" } };
